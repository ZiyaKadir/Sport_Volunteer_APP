...
class AkademiPage extends StatefulWidget {
  @override
  _Akademi_pageState createState() => _Akademi_pageState();
}
class _Akademi_pageState extends State<AkademiPage> {
  double screenWidth = 0;
    ...
    Future<void> getEducations() async {
      final Uri uri = Uri.parse('http://' + myip + '/mobileEducations');
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
        dataContainers = educations.map((Education current) {
          var resim;
          if(current.educationPhoto!=""){
          ...
          return GestureDetector(
            onTap: () {
              ...
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => DetailScreen4(education: educations[index]),
                ),
              );
            },
